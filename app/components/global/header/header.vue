<template>
  <header
    class="w-full mx-auto fixed py-2 px-4 bg-gray-100 dark:bg-gray-900 text-white transition-colors duration-300 ease-in-out z-50 rounded-b-lg shadow-sm border-b dark:border-gray-600"
  >
