<template>
  <section class="h-[calc(100dvh-(70px+1rem))] px-4">
    ...
    <div class="mb-4">
      ...
      <p class="text-gray-600 dark:text-gray-200">{{ EXPERIENCES_DETAILS_PT.bigdata.description }}</p>
    </div>
    ...
    <div>
      ...
      <ul class="list-disc list-outside pl-4 space-y-1">
        <li class="text-gray-600 dark:text-gray-200" v-for="action in EXPERIENCES_DETAILS_PT.bigdata.actions">
          <span>{{ action }}</span>
        </li>
      </ul>
    </div>
